...
public class SignUpVO {
    ...
    @Getter
    @Builder
    public static class GenSignUpRequestVO extends BaseColumn {
    ...
    @Getter
    @Builder
    public static class EntSignUpRequestVO extends BaseColumn {
        //기업 정보
        ...
        private Timestamp bzentFndnDt;      // 사업체 설립일
        ...
        private String prvCorpNo;         // 개인법인 번호
        ...
        private Timestamp picBrdt;            // 담당자 출생일자
    ...
    @Getter
    @Builder
    public static class InsertEntPrcptRequestVO extends BaseColumn {
